...
// ------ toString -------------------------------------------------------------------
  ...
  class StubPackageClassSymbol(val owner0: Symbol, name0: TypeName, val missingMessage: String) extends PackageClassSymbol(owner0, owner0.pos, name0) with StubSymbol
